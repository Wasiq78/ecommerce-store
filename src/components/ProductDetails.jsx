  ...
  return (
    <div className="mt-40">
      <div className="container relative overflow-hidden">
        <motion.div
          variants={animateProductTitle}
          initial="hidden"
          animate="visible"
          className="absolute w-full text-center text-4xl font-bold text-wrap"
        >
          <h2>{product.description}</h2>
        </motion.div>
        <div className="grid grid-cols-1 lg:grid-cols-[50%,45%] gap-0">
          <motion.div
            variants={animateProductImg}
            initial="hidden"
            animate="visible"
            className="flex flex-col gap-8 items-center justify-center w-full mt-10 h-fit mb-12 lg:mb-0"
          >
            <div>
          ...
          <motion.div
            variants={animateProductDetails}
            initial="hidden"
            animate="visible"
            className="bg-gray-200 px-6 sm:px-14 h-fit"
          >
            <div className="mt-16">
              ...
              <div className="flex flex-col gap-4 sm:justify-between mt-10 items-center  ">
                ...
                <div className="flex select-none">
                  <span
                    className="px-4 py-2  grid content-center text-xl border border-black font-bold bg-white cursor-pointer transition-all delay-200 ease-in hover:bg-transparent"
                    onClick={decrease}
                  >
                    <HiMiniMinusSmall />
                  </span>
                  ...
                  <span
                    className="px-4 py-2 border border-black grid content-center text-xl font-bold bg-white  cursor-pointer transition-all delay-200 ease-in hover:bg-transparent"
                    onClick={increase}
                  >
                    <GoPlus />
                  </span>
